...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( ap_CS_fsm_state5 );
    sensitive << ( ap_phi_mux_i_phi_fu_110_p4 );
    sensitive << ( i_reg_106 );
    ...
    SC_METHOD(thread_tmp_2_fu_134_p0);
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( x );

    SC_METHOD(thread_tmp_2_fu_134_p2);
    sensitive << ( tmp_2_fu_134_p0 );

    SC_METHOD(thread_tmp_4_fu_158_p1);
    sensitive << ( grp_fu_127_p2 );

    SC_METHOD(thread_tmp_5_fu_163_p1);
    ...
    sc_trace(mVcdFile, tmp_5_fu_163_p1, "tmp_5_fu_163_p1");
    sc_trace(mVcdFile, tmp_5_reg_204, "tmp_5_reg_204");
    ...
    sc_trace(mVcdFile, tmp_6_reg_224, "tmp_6_reg_224");
    sc_trace(mVcdFile, ap_CS_fsm_state4, "ap_CS_fsm_state4");
    sc_trace(mVcdFile, acc_1_fu_176_p2, "acc_1_fu_176_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, grp_fu_127_p2, "grp_fu_127_p2");
    sc_trace(mVcdFile, acc_reg_93, "acc_reg_93");
    sc_trace(mVcdFile, ap_phi_mux_i_phi_fu_110_p4, "ap_phi_mux_i_phi_fu_110_p4");
    ...
    sc_trace(mVcdFile, tmp_2_fu_134_p0, "tmp_2_fu_134_p0");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        acc_reg_93 = acc_1_fu_176_p2.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_reg_106 = grp_fu_127_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        i_reg_106 = ap_const_lv5_A;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,1,1>(tmp_1_reg_195.read(), ap_const_lv1_0))) {
        p_pn_reg_118 = tmp_6_reg_224.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(tmp_1_fu_152_p2.read(), ap_const_lv1_1))) {
        p_pn_reg_118 = tmp_2_reg_187.read();
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0))) {
        tmp_1_reg_195 = tmp_1_fu_152_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        tmp_2_reg_187 = tmp_2_fu_134_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(tmp_1_fu_152_p2.read(), ap_const_lv1_0))) {
        tmp_5_reg_204 = tmp_5_fu_163_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        tmp_6_reg_224 = tmp_6_fu_171_p2.read();
    }
}

void fir::thread_C1_address0() {
    C1_address0 =  (sc_lv<4>) (tmp_5_fu_163_p1.read());
}
...
void fir::thread_acc_1_fu_176_p2() {
    acc_1_fu_176_p2 = (!ap_phi_mux_p_pn_phi_fu_121_p4.read().is_01() || !acc_reg_93.read().is_01())? sc_lv<32>(): (sc_biguint<32>(ap_phi_mux_p_pn_phi_fu_121_p4.read()) + sc_biguint<32>(acc_reg_93.read()));
}
...
void fir::thread_ap_phi_mux_i_phi_fu_110_p4() {
    ap_phi_mux_i_phi_fu_110_p4 = i_reg_106.read();
}

void fir::thread_ap_phi_mux_p_pn_phi_fu_121_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,1,1>(tmp_1_reg_195.read(), ap_const_lv1_0))) {
        ap_phi_mux_p_pn_phi_fu_121_p4 = tmp_6_reg_224.read();
    } else {
...
void fir::thread_grp_fu_127_p0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        grp_fu_127_p0 = i_reg_106.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        grp_fu_127_p0 = ap_phi_mux_i_phi_fu_110_p4.read();
    } else {
        grp_fu_127_p0 = "XXXXX";
    }
}
...
void fir::thread_i_cast_fu_140_p1() {
    i_cast_fu_140_p1 = esl_sext<32,5>(i_reg_106.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<4>) (tmp_5_reg_204.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(tmp_1_fu_152_p2.read(), ap_const_lv1_1))) {
        ...
        shift_reg_address0 =  (sc_lv<4>) (tmp_4_fu_158_p1.read());
    } else {
...
void fir::thread_tmp_1_fu_152_p2() {
    tmp_1_fu_152_p2 = (!i_reg_106.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_106.read() == ap_const_lv5_0);
}

void fir::thread_tmp_2_fu_134_p0() {
    tmp_2_fu_134_p0 = x.read();
}

void fir::thread_tmp_2_fu_134_p2() {
    tmp_2_fu_134_p2 = (!tmp_2_fu_134_p0.read().is_01() || !ap_const_lv32_35.is_01())? sc_lv<32>(): sc_bigint<32>(tmp_2_fu_134_p0.read()) * sc_biguint<32>(ap_const_lv32_35);
}

void fir::thread_tmp_4_fu_158_p1() {
    tmp_4_fu_158_p1 = esl_zext<64,5>(grp_fu_127_p2.read());
}

void fir::thread_tmp_5_fu_163_p1() {
    tmp_5_fu_163_p1 = esl_zext<64,32>(i_cast_fu_140_p1.read());
}

void fir::thread_tmp_6_fu_171_p1() {
    tmp_6_fu_171_p1 = C1_load_reg_219.read();
}

void fir::thread_tmp_6_fu_171_p2() {
    tmp_6_fu_171_p2 = (!shift_reg_load_reg_214.read().is_01() || !tmp_6_fu_171_p1.read().is_01())? sc_lv<32>(): sc_bigint<32>(shift_reg_load_reg_214.read()) * sc_bigint<10>(tmp_6_fu_171_p1.read());
}

void fir::thread_tmp_fu_144_p3() {
    tmp_fu_144_p3 = i_reg_106.read().range(4, 4);
}
    ...
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(tmp_1_fu_152_p2.read(), ap_const_lv1_1))) {
