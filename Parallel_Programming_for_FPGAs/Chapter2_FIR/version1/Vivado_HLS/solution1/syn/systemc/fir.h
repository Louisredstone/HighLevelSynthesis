...
struct fir : public sc_module {
    ...
    sc_signal< sc_lv<32> > tmp_2_fu_134_p2;
    sc_signal< sc_lv<32> > tmp_2_reg_187;
    sc_signal< sc_lv<1> > tmp_1_fu_152_p2;
    sc_signal< sc_lv<1> > tmp_1_reg_195;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<1> > tmp_fu_144_p3;
    sc_signal< sc_lv<64> > tmp_5_fu_163_p1;
    sc_signal< sc_lv<64> > tmp_5_reg_204;
    sc_signal< sc_lv<32> > shift_reg_load_reg_214;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<10> > C1_load_reg_219;
    sc_signal< sc_lv<32> > tmp_6_fu_171_p2;
    sc_signal< sc_lv<32> > tmp_6_reg_224;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<32> > acc_1_fu_176_p2;
    sc_signal< sc_logic > ap_CS_fsm_state5;
    sc_signal< sc_lv<5> > grp_fu_127_p2;
    sc_signal< sc_lv<32> > acc_reg_93;
    sc_signal< sc_lv<5> > ap_phi_mux_i_phi_fu_110_p4;
    sc_signal< sc_lv<5> > i_reg_106;
    ...
    sc_signal< sc_lv<32> > tmp_2_fu_134_p0;
    sc_signal< sc_lv<32> > i_cast_fu_140_p1;
    sc_signal< sc_lv<10> > tmp_6_fu_171_p1;
    ...
    void thread_ap_done();
    void thread_ap_idle();
    void thread_ap_phi_mux_i_phi_fu_110_p4();
